...
<body class="gray-bg">
	<div class="wrapper wrapper-content animated fadeInRight">
		<div class="row">
			<div class="col-sm-12">
				<div class="col-sm-12">
					<div class="alert alert-success">
						<button aria-hidden="true" data-dismiss="alert" class="close"
							type="button">×</button>
						模板方式（验证码）：模版编码为：vercode，   参数为：123456 <br>
						模板方式（通知）：模版编码为：309425，   参数为：某某某女士/先生,2018-04-18 00:00:00
					</div>
				</div>
				<div class="col-sm-6">
					<div class="portlet box  portlet-grey">
						<div class="portlet-header">
							<div class="caption">短信发送(验证码测试)</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<form:form id="smsForm"
								action="${adminPath}/sms/send/ucpaasSendSmsByCode" method="post"
								...
								<div class="form-group col-sm-12">
									...
									<div class="col-sm-8">
										<form:input path="phone" class="form-control" nested="false"
											datatype="*" placeholder="电话号码“,”隔开" htmlEscape="false" />
									</div>
								</div>
								<div class="form-group col-sm-12">
									...
									<div class="col-sm-8">
										<form:input path="code" class="form-control" nested="false"
											datatype="*" placeholder="这里的编码需要在模版配置中能找到"
											htmlEscape="false" />
									</div>
								</div>
								<div class="form-group col-sm-12">
				...
				<div class="col-sm-6">
					<div class="portlet box  portlet-grey">
						<div class="portlet-header">
							<div class="caption">短信发送(通知测试)</div>
							<div class="tools">
								<i class="fa fa-chevron-up"></i> <i class="fa fa-refresh"></i><i
									class="fa fa-times"></i>
							</div>
		...
		<script type="text/javascript">
			...
			function testHySms() {
				$("#smsForm").attr("action",
						"${adminPath}/sys/setting/testHySms");
