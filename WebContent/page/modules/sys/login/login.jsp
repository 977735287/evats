...
<body id="signin-page">
	<div class="page-form">
		<form id="loginform" method="post" class="form">
			<div class="header-content">
				<h1>
					<spring:message code="sys.login.submit.label" />
				</h1>
			...
			<div class="body-content">
				<div class="form-group">
					<div class="input-icon right">
						<i class="fa fa-user"></i> <input name="username"
							class="form-control"
							placeholder="<spring:message code="sys.login.username.placeholder"/>"
							required="">
					</div>
				</div>
				<div class="form-group">
					<div class="input-icon right">
						<i class="fa fa-key"></i> <input name="password"
							class="form-control"
					...
					<div class="form-group">
						<div class="pull-left">
							<input name="jcaptchaCode" class="form-control"
								placeholder="<spring:message code="sys.login.captcha.placeholder"/>"
								required="">
						</div>
						<div class="pull-right">
							<img id="img_jcaptcha" src="${appPath}/jcaptcha.jpg" width="100"
								height="35" onclick="changeJcaptchaSrc();" />
						</div>
					</div>
					...
					<div class="pull-left">
						<div class="checkbox-list">
							<label><input id="rememberMe" type="checkbox"
								name="rememberMe" value="1" class="i-checks">&nbsp; <spring:message
									code="sys.login.rememberMe" /></label>
						</div>
					</div>
					<div class="pull-right">
				...
				<hr>
				<p>
					如果您没有帐号? <a id="btn-register" href="#">请注册</a>
				</p>
			</div>
		</form>
	</div>
	...
	<script>
		...
		function changeJcaptchaSrc() {
			document.getElementById("img_jcaptcha").src = '${appPath}/jcaptcha.jpg?_='
					+ (new Date()).getTime();
		}
	</script>
