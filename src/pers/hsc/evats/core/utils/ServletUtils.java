...
public abstract class ServletUtils {
	// 静态文件后缀
	private final static String[] staticFiles = StringUtils.split(EvatsPropertiesUtil.getConfig("web.staticFile"), ",");

	// 动态映射URL后缀
	private final static String urlSuffix = EvatsPropertiesUtil.getConfig("urlSuffix");
