...
import pers.hsc.evats.core.utils.EvatsPropertiesUtil;
...
public class CacheSessionDAO extends EnterpriseCacheSessionDAO implements SessionDAO {
	...
	protected void doUpdate(Session session) {
		...
		if (request != null) {
			...
			// 如果是视图文件，则不更新SESSION
			if (StringUtils.startsWith(uri, EvatsPropertiesUtil.getConfig("web.view.prefix"))
					&& StringUtils.endsWith(uri, EvatsPropertiesUtil.getConfig("web.view.suffix"))) {
				return;
			}
			// 手动控制不更新SESSION
